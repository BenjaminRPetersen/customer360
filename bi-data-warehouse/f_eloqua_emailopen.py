# -*- coding: utf-8 -*-
"""
Title: f_eloqua_emailopen Scheduler
...
cur.execute("call customer360.f_eloqua_emailopen(); commit;")
rows = conn.execute("select count(*) ct from customer360.f_eloqua_emailopen").fetchall()[0][0]
