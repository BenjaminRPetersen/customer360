# -*- coding: utf-8 -*-
"""
Title: f_eloqua_pageview Scheduler
...
cur.execute("call customer360.f_eloqua_pageview(); commit;")
rows = conn.execute("select count(*) ct from customer360.f_eloqua_pageview").fetchall()[0][0]
