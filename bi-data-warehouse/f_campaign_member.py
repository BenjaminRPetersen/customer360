...
cur.execute("call customer360.f_campaign_member(); commit;")
rows = conn.execute("select count(*) ct from customer360.f_campaign_member").fetchall()[0][0]
