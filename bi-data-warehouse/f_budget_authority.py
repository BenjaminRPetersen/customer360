# -*- coding: utf-8 -*-
"""
Title: f_budget_authority Scheduler
...
cur.execute("call customer360.f_budget_authority(); commit;")
rows = conn.execute("select count(*) ct from customer360.f_budget_authority").fetchall()[0][0]
