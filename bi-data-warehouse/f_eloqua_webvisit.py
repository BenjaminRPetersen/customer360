# -*- coding: utf-8 -*-
"""
Title: f_eloqua_webvisit Scheduler
...
cur.execute("call customer360.f_eloqua_webvisit(); commit;")
rows = conn.execute("select count(*) ct from customer360.f_eloqua_webvisit").fetchall()[0][0]
