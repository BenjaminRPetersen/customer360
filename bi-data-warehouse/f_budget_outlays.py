# -*- coding: utf-8 -*-
"""
Title: f_budget_outlays Scheduler
...
cur.execute("call customer360.f_budget_outlays(); commit;")
rows = conn.execute("select count(*) ct from customer360.f_budget_outlays").fetchall()[0][0]
