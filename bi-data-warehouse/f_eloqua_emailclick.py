# -*- coding: utf-8 -*-
"""
Title: f_eloqua_emailclick Scheduler
...
cur.execute("call customer360.f_eloqua_emailclick(); commit;")
rows = conn.execute("select count(*) ct from customer360.f_eloqua_emailclick").fetchall()[0][0]
