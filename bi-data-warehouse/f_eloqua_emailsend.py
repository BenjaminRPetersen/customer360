# -*- coding: utf-8 -*-
"""
Title: f_eloqua_emailsend Scheduler
...
cur.execute("call customer360.f_eloqua_emailsend(); commit;")
rows = conn.execute("select count(*) ct from customer360.f_eloqua_emailsend").fetchall()[0][0]
